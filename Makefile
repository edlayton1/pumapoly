...
SOURCES += DLL.cpp Stack.cpp Lugares.cpp Monopoly.cpp graph.cpp Vertex.cpp quicksort.cpp bubble.cpp
#aquí ponemos el resto de fuentes (.c)

EXECUTABLE = monopoly.out
#nuestro ejecutable

DEPS = DLL.hpp Lugares.hpp Monopoly.hpp Stack.hpp graph.hpp Vertex.hpp quicksort.hpp bubble.hpp
